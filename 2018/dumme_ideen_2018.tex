...
% TODO: Strecke auf Landkarte
% TODO: Quelle Joakim

\attribution{Joakim Broden von Sabaton, der aufgrund einer verlorenen Wette zu Fuß auf ein Festival gegangen ist.}

Ich finde Wetten unter Freunden immer ganz nett, aber dabei geht es mir eigentlich nie darum, Recht zu haben.
Viel mehr reizen mich lustige Wetteinsätze, die Leute in unangenehme Situationen bringen - und natürlich das Risiko zu verlieren, und den Einsatz selbst einlösen zu müssen.

Ein Beispiel für einen guten Wetteinsatz ist es, mit dem Fahrrad auf ein Musikfestival (in meinem Fall das \emph{Summerbreeze}) zu fahren.
Von meinem Heimatort Regensburg aus ist das eine ordentliche, aber machbare Tour mit Übernachtungen.
Zelt und Campingkocher kann man dann auch auf dem Festival gut brauchen und mittlerweile kann man da auch duschen.
Und ein großer Vorteil des Ganzen:
Mit dem Radl ist man deutlich schneller bei den Bühnen als zu Fuß!
...
Bilder mit inspirierenden, motivierenden oder aufmunternden Sprüchen gibt es schon lange und durch die rasant fortschreitende technologische Entwicklung sind nun auch alle, die eine Maus richtig herum halten können, in der Lage, selbst solche Bilder zu erstellen.
Ganz beliebt sind dabei natürlich Zitate berühmter Persönlichkeiten - und dabei ist es dann auch nicht so wahnsinnig wichtig, ob die Person das auch wirklich gesagt hat.
Für den WhatsApp-Status taugts schon.

Doch auf das physische Äquivalent der \emph{Nachdenklichen Sprüche mit Bilder}, also kleine Bücher mit wohlklingenden Titeln wie ``365 schöne Gedanken für jeden Tag im Jahr'', sowie Abreiß-Tageskalender, hat das Phänomen der falsch zugeordneten Zitate noch nicht übergegriffen.
Deshalb ist es allerhöchste Zeit, dass dies nachgeholt wird und es Abreißkalender mit Fotos von Martin Luther King gibt, der gerade ``Yes, we can!'' sagt.
Die sechzehnjährigen Mädels, die sich heute auf Insta tummeln, sind schneller Mitte dreißig als man denkt - und dann hat man zumindest schon ein gutes Geburtstagsgeschenk.
